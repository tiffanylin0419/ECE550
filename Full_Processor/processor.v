...
module processor(
    ...
    /* YOUR CODE STARTS HERE */
	 ...
	 wire the_R, the_addi,the_sw,the_lw,the_beq,the_j,the_bne,the_blt,the_jr,the_jal,the_bex,the_setx;
	 wire DMwe,Rwe,Rwd,Rdst,ALUop,ALUinB,BNE,BLT,JR;
	 //pc & imem
	 ...
	 and a3(w3,the_bex,isNotEqual);
	 or o1(w2,w0,w1,w3);
	 assign pcn1=pcn1_32[11:0];
	 assign jrin1=w2?pcn1:pc1;
	 assign jin1=JR? data_readRegA[11:0]:jrin1;
	 assign pc_in=(the_j|the_jal)?target[11:0]:jin1;
	 ...
	 control_circuit c1( opcode,the_R, the_addi,the_sw,the_lw,the_beq,the_j,the_bne,the_blt,the_jr,the_jal,the_bex,the_setx,DMwe,Rwe,Rwd,Rdst,ALUop,ALUinB,BNE,BLT,JR);
	 
	 assign overflow=(is_overflow&(is_addi|is_add|is_sub));
	 assign ctrl_writeEnable=Rwe;
	 assign ctrl_writeReg=the_jal?5'b11111:(overflow|the_setx)?5'b11110:rd;
	 assign ctrl_readRegA=the_bex?5'b11110:(the_bne|the_blt|the_jr)?rd:rs;
	 assign ctrl_readRegB=(the_bne|the_blt)?rs:the_sw?rd:rt;//rd when sw
	 assign data_writeReg=the_setx?target:the_jal?pc1_32:Rwd?q_dmem:~overflow?aluout:is_add?32'd1:is_addi?32'd2:is_sub?32'd3:32'd0;
	 
	 //alu
	
	 assign aluin1=data_readRegA;
	 assign aluin2=the_bex?32'b0:ALUinB?immediate:data_readRegB;
